...
class Service(object):
    ...
    def title_norminal(this) -> object:
        ...
        for dataset in combine:
            ...
            # 정규식, 알파벳만 있는 글자[...]이고, \는 .을 특수기호 아닌 자연어로 해석. Mr.의 의미를 갖는다.
        for dataset in combine:
            ...
            title_mapping = {'Mr': 1, 'Miss': 2, 'Mrs': 3, 'Master': 4, 'Royal': 5, 'Rare': 6}  # Nominal(순서없는 숫자표현)
    ...
    def age_ordinal(this) -> object:
        ...
        bins = [-1, 0, 5, 12, 18, 24, 35, 68, np.inf]   # -1~0:알수없음, 0~5:유아, 5~12:어린이, 10대, 학생, 청년, 중장년, 노년
